...
namespace MvcApplication1.Controllers
{
    ...
    public class MusiclistController : Controller
    {
        ...
        {
            string url = "https://gdata.youtube.com/feeds/api/playlists/" + id + "?start-index="+ index +"&max-results=" + maxResults + "&alt=jsonc&v=2";
        ...
        {
            string url = "https://api.soundcloud.com/playlists/"+ id + ".json?client_id=" + SOUNDCLOUD_CLIENT_KEY + "&limit=" + maxResults + "&offset=" + index;
