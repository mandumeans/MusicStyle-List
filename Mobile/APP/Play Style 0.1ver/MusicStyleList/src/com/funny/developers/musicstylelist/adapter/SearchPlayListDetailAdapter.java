...
public class SearchPlayListDetailAdapter extends BaseListAdapter implements OnClickListener{ 
	
	public SearchPlayListDetailAdapter(Context context) {
		super(context);
	}
	...
	public View getItemView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null) {
			...
			holder.mOnlyYoutube = (TextView)convertView.findViewById(R.id.list_only_youtube_text_view);
		...
		if(item.onlyYoutube == Define.NOT_ONLY_YOUTUBE_TYPE){
			holder.mOnlyYoutube.setVisibility(View.GONE);
		} else {
			holder.mOnlyYoutube.setVisibility(View.VISIBLE);
		}
