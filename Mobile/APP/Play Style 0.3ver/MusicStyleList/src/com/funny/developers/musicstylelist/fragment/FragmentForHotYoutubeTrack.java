...
public class FragmentForHotYoutubeTrack extends BaseFragment implements OnPullToRefresh{
	...
	public FragmentForHotYoutubeTrack(){
		super();
	}
	
	public FragmentForHotYoutubeTrack(Context context){
		super(context);
	}
	...
	public String onRequestGetParameter() {
		return ParameterUrl.YoutubeHotTrack(SettingUtils.getYoutubeFavoriteType(getActivity()), listParser.getPageToken());
	}

	@Override
	public String onRequestGetUrl() {
		return RequestUrl.HotYoutubeTrackSearchUrl();
	}
