...
import com.funny.developers.musicstylelist.activity.YoutubePlayerViewActivity;
...
public class NavigationUtils {
	...
	public static void goYoutubePlayer(Context context, ArrayList<BaseModel> trackList, int playTrackNum){
		
		Intent intent = new Intent(context, YoutubePlayerViewActivity.class);
		intent.putExtra(Define.YOUTUBE_TRACK_LIST_INTENT, trackList);
		intent.putExtra(Define.YOUTUBE_TRACK_LIST_POSITION, playTrackNum);
		context.startActivity(intent);
	}
