...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    public SlidingTabLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mDisplayWidth = (int) getResources().getDisplayMetrics().widthPixels;
     ...
     */
    public void setDividerColors(String colors) {
        mTabStrip.setDividerColors(Color.parseColor(colors));
    }
    ...
    public void setTabTextColor(String textColor){
    ...
    private void populateTabStrip() {
        ...
        int tabViewWidth = mDisplayWidth / itemCount;
        ...
        for (int i = 0; i < itemCount; i++) {
            ...
            if (tabView == null) {
                tabView = createDefaultTabView(getContext(), tabViewWidth);
            }
