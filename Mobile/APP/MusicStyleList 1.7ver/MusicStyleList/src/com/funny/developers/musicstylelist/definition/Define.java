...
public class Define {
	...
	//searchUrl
	public static final String BASE_API_URL = "http://rlaqnqn.dothome.co.kr/MusicList/";
	...
	//only youtube 
	public static final int ONLY_YOUTUBE_TYPE = 1;
	public static final int NOT_ONLY_YOUTUBE_TYPE = 2;

	public static final String YOUTUBE_URL_CANT_USE = "can_not_use";
	public static final String YOUTUBE_URL_NOT_FIND ="not_find";
	public static final String YOUTUBE_RTSP_URL = "connect_rtsp_url";
	public static final String YOUTUBE_NOT_RTSP_URL = "connect_not_rtsp_url";

	//search type
	public static final int YOUTUBE_SEARCH = 1;
	public static final int SOUND_CLOUD_SEARCH = 2;

	//track search index initial
	public static final int INDEX_INITIALIZE_COMMEND = 0;
	public static final int INDEX_PLUS_COMMEND = 1;
	...
	public static final String YOUTUBE_TRACK_LIST_INTENT = "youtube_track_list_intent";
	public static final String YOUTUBE_TRACK_LIST_POSITION = "youtube_track_list_position";
