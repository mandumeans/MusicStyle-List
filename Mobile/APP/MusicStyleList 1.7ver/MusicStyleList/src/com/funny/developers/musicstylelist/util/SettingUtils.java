...
public class SettingUtils {
	...
	public static boolean getUseYTPlayerType(Context context){
		SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
		return prefs.getBoolean("pref_only_youtube_player", false);
	}
	
	public static String getFavoriteType(Context context){
		SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
